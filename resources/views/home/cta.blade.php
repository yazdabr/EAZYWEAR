    ...
    <x-ui.container>
        ...
        <x-ui.reveal animation="scale">
            ...
            <div
                ...
                {{-- Overlay --}}
                <div
                    class="absolute inset-0 bg-white/60 backdrop-blur-[1px] sm:hidden">
                </div>
                ...
                <div class="relative z-10">
                    ...
                    {{-- Label --}}
                    <p
                        class="mb-2 text-[9px] font-semibold uppercase tracking-[0.2em] text-[#AE7C18] sm:mb-4 sm:text-xs sm:tracking-[0.3em]">
                    ...
                    {{-- Title --}}
                    <h2
                        class="mx-auto max-w-3xl text-xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl">
                    ...
                    {{-- Description --}}
                    <p
                        class="mx-auto mt-2 max-w-2xl text-xs leading-relaxed text-gray-700 sm:mt-6 sm:text-base sm:leading-8 lg:text-lg">
                    ...
                    <div class="mt-6 sm:mt-10">
                        ...
                        <x-ui.button
                            ...
                            <x-heroicon-o-chat-bubble-left-right
                                class="mr-1.5 h-4 w-4 sm:mr-2 sm:h-6 sm:w-6"/>
