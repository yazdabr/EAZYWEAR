            ...
            <div class="flex flex-col">
                ...
                <x-ui.reveal animation="right" :delay="0">
                    <div class="mb-3 flex items-center gap-2.5 sm:mb-6 sm:gap-3">
                        ...
                        <span class="text-[10px] font-semibold uppercase tracking-[0.2em] text-[#AE7C18] sm:text-xs sm:tracking-[0.3em]">
                            OUR LEGACY
                        </span>
                    </div>
                </x-ui.reveal>
                ...
                <div class="relative mx-auto w-full max-w-[240px] sm:max-w-md lg:max-w-none">
                    ...
                    <div class="absolute -bottom-3 -left-3 z-10 sm:-bottom-6 sm:-left-4">
                        <x-ui.reveal animation="scale" :delay="350">
                            <div class="flex items-center gap-2 rounded-xl bg-[#AE7C18] px-3 py-2 text-white shadow-md sm:gap-3.5 sm:rounded-2xl sm:px-6 sm:py-4 sm:shadow-xl">
