    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <div
                    class="flex h-10 w-10 items-center justify-center rounded-full bg-[#AE7C18]/10">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        {{-- <span
                            class="rounded-full bg-[#AE7C18]/10 px-3 py-1 text-[11px] font-semibold text-[#AE7C18]"
                            x-text="mode==='create'
                                ? 'NEW'
                                : 'EDIT'">
        ...
        <div class="flex-1 space-y-6 overflow-y-auto bg-slate-100 p-6">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="mb-6 flex items-start gap-4">
                    ...
                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#AE7C18]/10">
                ...
                <div class="mt-6">
                    ...
                    <x-admin.textarea
                        ...
                        placeholder="Describe materials, specifications and product features..." />

                    <p class="mt-2 text-xs text-slate-400">

                        This description will help customers understand your product.
                ...
                <div class="mb-6 flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">
                            ...
                            Configure selling price and available stock.
        ...
        {{-- ================= FOOTER ================= --}}
        <div
            class="sticky bottom-0 flex items-center justify-between border-t border-slate-200 bg-white px-6 py-5">
            ...
            <div>
                ...
                <p class="text-xs text-slate-400">
                    ...
                    Save now or continue editing later.
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                    ...
                    class="rounded-xl bg-[#AE7C18] px-6 py-3 font-semibold text-white shadow-lg shadow-[#AE7C18]/20 transition-all duration-300 hover:bg-[#96690F] hover:shadow-xl hover:shadow-[#AE7C18]/30 active:scale-95">
