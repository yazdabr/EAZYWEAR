    ...
    <x-ui.container>
        ...
        @if($cart->isEmpty())
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 text-center shadow-sm sm:rounded-3xl sm:py-14">
                ...
                <a
                    href="{{ route('catalog') }}"
                    class="mt-5 inline-flex items-center justify-center rounded-full bg-slate-900 px-6 py-3 text-xs font-semibold text-white transition hover:bg-slate-800 sm:mt-6 sm:text-sm"
                >
                    Explore Catalog
                </a>
            </div>
        ...
        @else
            ...
            <div class="grid gap-6 lg:grid-cols-3 lg:gap-8">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div class="flex items-start justify-between gap-2">
                                        ...
                                        >
                                            ...
                                            <button
                                                type="submit"
                                                class="rounded-full p-1.5 text-gray-400 transition hover:bg-red-50 hover:text-red-500 sm:p-2"
                                        ...
                                        <div class="flex items-center justify-between sm:justify-end gap-3">
                                            ...
                                            >
                                                ...
                                                <button
                                                    ...
                                                    class="flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 text-gray-600 transition hover:border-[#AE7C18] hover:text-[#AE7C18] sm:h-9 sm:w-9"
                                                    @disabled($item['qty'] <= 1)
                                                >
                                                    −
                                                </button>
                                                ...
                                                <button
                                                    type="submit"
                                                    name="qty"
                                                    value="{{ min($item['stock'], $item['qty'] + 1) }}"
                                                    class="flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 text-gray-600 transition hover:border-[#AE7C18] hover:text-[#AE7C18] sm:h-9 sm:w-9"
                ...
                <div class="flex items-center justify-between gap-2 pt-2">
                    <a
                        href="{{ route('catalog') }}"
                        class="inline-flex shrink-0 items-center justify-center rounded-full border border-gray-300 px-3.5 py-2.5 text-xs font-semibold text-gray-700 transition hover:border-[#AE7C18] hover:text-[#AE7C18] sm:px-5 sm:py-3 sm:text-sm"
                    >
                        Continue Shopping
                    </a>
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            class="inline-flex items-center justify-center rounded-full px-3.5 py-2.5 text-xs font-semibold text-red-500 transition hover:bg-red-50 sm:px-5 sm:py-3 sm:text-sm"
                        >
                            Clear Cart
                        </button>
                    </form>
                ...
                <aside class="h-fit rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:rounded-3xl sm:p-6 lg:sticky lg:top-28">
                    ...
                    <div class="mt-4 space-y-3 sm:mt-6 sm:space-y-4">
                        ...
                        <a
                            ...
                            class="mt-3 inline-flex w-full items-center justify-center rounded-full bg-[#AE7C18] px-6 py-3.5 text-xs font-semibold text-white shadow-lg shadow-slate-900/20 transition hover:bg-slate-800 sm:mt-4 sm:py-4 sm:text-sm"
                        >
                            Proceed to Checkout
                        </a>
