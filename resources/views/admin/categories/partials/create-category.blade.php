    ...
    >
        ...
        <div class="flex items-center justify-between border-t border-slate-200 bg-white px-5 py-4 sm:px-6 sm:py-5">
            ...
            <button
                ...
                @click="closeDrawer()"
                :disabled="loading"
                class="rounded-xl border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50 sm:px-5 sm:py-3 sm:text-base"
            >
                Batal
            </button>
            ...
            <button
                ...
                @click="submitForm()"
                :disabled="loading"
                class="inline-flex min-w-[150px] items-center justify-center gap-2 rounded-xl bg-[#AE7C18] px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-[#AE7C18]/20 transition-all duration-300 hover:bg-[#96690F] hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-60 sm:px-6 sm:py-3 sm:text-base"
            >
                <svg
                    x-show="loading"
