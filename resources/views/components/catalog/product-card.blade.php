...
<div class="group flex h-full min-h-full flex-col overflow-hidden rounded-xl border border-gray-100 bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg lg:rounded-2xl">
    <div
    ...
    <div class="flex flex-1 flex-col px-2.5 py-2.5 sm:px-3 sm:py-3 lg:px-4 lg:py-4">
        ...
        <h3 class="mt-1 min-h-[2rem] text-sm font-bold leading-4 text-slate-900 transition-colors duration-300 group-hover:text-[#AE7C18] sm:min-h-[2.5rem] sm:text-[15px] sm:leading-5 lg:mt-1.5 lg:min-h-[2.75rem] lg:text-lg lg:leading-6">
            {{ $product->name }}
        </h3>
