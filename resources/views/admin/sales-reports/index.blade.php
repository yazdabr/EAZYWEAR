...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
            ...
            <p class="mt-1 text-xs text-slate-500 sm:text-sm">Analisis kinerja penjualan dan pendapatan Anda.</p>
        </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:px-6 sm:py-4">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-slate-600 sm:text-sm">Gambaran laporan penjualan</span>
            </div>
            <span class="text-xs font-medium text-slate-500 sm:text-sm">Semua data penjualan</span>
        </div>
    </div>
...
<div class="rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm transition-all sm:rounded-3xl sm:p-6">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:rounded-3xl sm:p-6">
        <div class="flex flex-col gap-3 border-b border-slate-100 pb-4 sm:flex-row sm:items-center sm:justify-between sm:pb-5">
            <div>
                ...
                <p class="mt-0.5 text-xs text-slate-500 sm:mt-1 sm:text-sm">Kinerja pendapatan bulanan.</p>
            </div>
            <div>
        ...
        <div class="mt-4 h-[280px] sm:mt-6 sm:h-[360px]">
            <div class="flex h-full items-center justify-center rounded-2xl bg-slate-50 p-4">
                <div class="text-center">
                    ...
                    <p class="mt-3 text-sm font-semibold text-slate-700 sm:mt-4 sm:text-base">Grafik Pendapatan</p>
                    <p class="mt-1 text-xs text-slate-400 sm:text-sm">Data grafik akan terhubung dengan transaksi penjualan.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm sm:rounded-3xl">
        <div class="flex flex-col gap-2 border-b border-slate-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-5">
            <div>
                ...
                <p class="mt-0.5 text-xs text-slate-500 sm:mt-1 sm:text-sm">Produk terlaris berdasarkan unit terjual.</p>
            </div>
            <span class="inline-flex w-fit items-center rounded-full bg-[#AE7C18]/10 px-3 py-1 text-xs font-semibold text-[#AE7C18] sm:py-1.5">5 Produk Teratas</span>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full">
                <thead class="border-b border-slate-200 bg-slate-50">
                    <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-500">
                        <th class="whitespace-nowrap px-4 py-3 sm:px-6 sm:py-4">Produk</th>
                        <th class="whitespace-nowrap px-4 py-3 text-center sm:px-6 sm:py-4">Unit Terjual</th>
                        <th class="whitespace-nowrap px-4 py-3 text-right sm:px-6 sm:py-4">Pendapatan</th>
                        <th class="whitespace-nowrap px-4 py-3 text-right sm:px-6 sm:py-4">Pangsa</th>
                    </tr>
                </thead>
        ...
        <div class="flex items-center justify-between border-t border-slate-200 p-4 sm:px-6 sm:py-4">
            <p class="text-xs text-slate-500 sm:text-sm">Menampilkan 5 produk teratas</p>
            <button type="button" class="text-xs font-semibold text-[#AE7C18] transition hover:underline sm:text-sm">Lihat Semua Produk</button>
        </div>
    </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm sm:rounded-3xl">
        <div class="flex flex-col gap-2 border-b border-slate-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-5">
            <div>
                ...
                <p class="mt-0.5 text-xs text-slate-500 sm:mt-1 sm:text-sm">Kinerja penjualan berdasarkan kategori produk.</p>
            </div>
            <span class="inline-flex w-fit items-center rounded-full bg-[#AE7C18]/10 px-3 py-1 text-xs font-semibold text-[#AE7C18] sm:py-1.5">Semua Kategori</span>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full">
                <thead class="border-b border-slate-200 bg-slate-50">
                    <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-500">
                        <th class="whitespace-nowrap px-4 py-3 sm:px-6 sm:py-4">Kategori</th>
                        <th class="whitespace-nowrap px-4 py-3 text-center sm:px-6 sm:py-4">Produk Terjual</th>
                        <th class="whitespace-nowrap px-4 py-3 text-right sm:px-6 sm:py-4">Pendapatan</th>
                        <th class="whitespace-nowrap px-4 py-3 text-right sm:px-6 sm:py-4">Pangsa</th>
                    </tr>
                </thead>
        ...
        <div class="flex items-center justify-between border-t border-slate-200 p-4 sm:px-6 sm:py-4">
            <p class="text-xs text-slate-500 sm:text-sm">Menampilkan {{ count($salesCategories) }} kategori</p>
            <button type="button" class="text-xs font-semibold text-[#AE7C18] transition hover:underline sm:text-sm">Lihat Semua Kategori</button>
        </div>
    </div>
    ...
    @php
    $paymentMethods = [
        ['name' => 'Tunai', 'transactions' => 42, 'revenue' => 'Rp8.240.000', 'percentage' => 33, 'icon' => 'banknotes'],
        ['name' => 'QRIS', 'transactions' => 38, 'revenue' => 'Rp7.180.000', 'percentage' => 30, 'icon' => 'qr-code'],
        ['name' => 'Transfer Bank', 'transactions' => 29, 'revenue' => 'Rp5.920.000', 'percentage' => 23, 'icon' => 'building-library'],
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm sm:rounded-3xl">
        <div class="flex flex-col gap-2 border-b border-slate-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-5">
            <div>
                ...
                <p class="mt-0.5 text-xs text-slate-500 sm:mt-1 sm:text-sm">Distribusi transaksi berdasarkan metode pembayaran.</p>
            </div>
            <span class="inline-flex w-fit items-center rounded-full bg-[#AE7C18]/10 px-3 py-1 text-xs font-semibold text-[#AE7C18] sm:py-1.5">4 Metode Pembayaran</span>
        </div>
                ...
                <div class="rounded-2xl border border-slate-200 p-4 transition hover:border-slate-300 hover:shadow-sm sm:p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-slate-400 sm:mt-1">{{ $payment['transactions'] }} transaksi</p>
                        </div>
                    ...
                    <div class="mt-3 sm:mt-4">
                        <div class="mb-1.5 flex items-center justify-between sm:mb-2">
                            <span class="text-xs text-slate-500">Pangsa</span>
    ...
    @php
    $reportTransactions = [
        ['invoice' => 'INV-20260808-001', 'date' => '08 Agu 2026', 'customer' => 'John Doe', 'payment' => 'QRIS', 'status' => 'Lunas', 'total' => 'Rp517.000'],
        ['invoice' => 'INV-20260808-002', 'date' => '08 Agu 2026', 'customer' => 'Sarah Wilson', 'payment' => 'Tunai', 'status' => 'Selesai', 'total' => 'Rp298.000'],
        ['invoice' => 'INV-20260807-003', 'date' => '07 Agu 2026', 'customer' => 'Michael Brown', 'payment' => 'Transfer Bank', 'status' => 'Selesai', 'total' => 'Rp745.000'],
        ['invoice' => 'INV-20260807-004', 'date' => '07 Agu 2026', 'customer' => 'Emily Davis', 'payment' => 'EDC', 'status' => 'Lunas', 'total' => 'Rp425.000'],
        ['invoice' => 'INV-20260806-005', 'date' => '06 Agu 2026', 'customer' => 'James Anderson', 'payment' => 'QRIS', 'status' => 'Selesai', 'total' => 'Rp632.000'],
    ];
    @endphp
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm sm:rounded-3xl">
        <div class="flex flex-col gap-2 border-b border-slate-200 p-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-5">
            <div>
                ...
                <p class="mt-0.5 text-xs text-slate-500 sm:mt-1 sm:text-sm">Catatan transaksi lengkap untuk periode terpilih.</p>
            </div>
            <span class="inline-flex w-fit items-center rounded-full bg-[#AE7C18]/10 px-3 py-1 text-xs font-semibold text-[#AE7C18] sm:py-1.5">
                {{ count($reportTransactions) }} Transaksi
            </span>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full">
                <thead class="border-b border-slate-200 bg-slate-50">
                    <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-500">
                        <th class="whitespace-nowrap px-4 py-3 sm:px-6 sm:py-4">Faktur</th>
                        <th class="whitespace-nowrap px-4 py-3 sm:px-6 sm:py-4">Tanggal</th>
                        <th class="whitespace-nowrap px-4 py-3 sm:px-6 sm:py-4">Pelanggan</th>
                        <th class="whitespace-nowrap px-4 py-3 text-center sm:px-6 sm:py-4">Pembayaran</th>
                    ...
                    @foreach($reportTransactions as $transaction)
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="whitespace-nowrap px-4 py-4 text-center sm:px-6 sm:py-5">
                                @if($transaction['payment'] === 'Tunai')
                                    <span class="inline-flex items-center rounded-full bg-emerald-100 px-2.5 py-0.5 text-xs font-semibold text-emerald-700 sm:px-3 sm:py-1">Tunai</span>
                                ...
                                @elseif($transaction['payment'] === 'Transfer Bank')
                                    <span class="inline-flex items-center rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-semibold text-blue-700 sm:px-3 sm:py-1">Transfer Bank</span>
                                @else
        ...
        {{-- BAGIAN BAWAH --}}
        <div class="flex items-center justify-between border-t border-slate-200 p-4 sm:px-6 sm:py-4">
            <p class="text-xs text-slate-500 sm:text-sm">Menampilkan {{ count($reportTransactions) }} transaksi</p>
            <button type="button" class="text-xs font-semibold text-[#AE7C18] transition hover:underline sm:text-sm">Lihat Daftar Transaksi</button>
        </div>
    </div>
</div>
@endsection