                                ...
                                <div class="flex items-start justify-between gap-3 text-xs sm:gap-4 sm:text-sm">
                                    <div class="min-w-0 flex-1">
                                        ...
                                        @if(!empty($item->custom_name))
                                            <p class="mt-1.5 text-xs font-bold tracking-wide text-[#AE7C18] sm:text-sm">Nama Jersey: {{ $item->custom_name }}</p>
                                        @endif
                                        @if(!empty($item->custom_number))
                                            <p class="mt-1 text-xs font-bold tracking-wide text-slate-700 sm:text-sm">Nomor Punggung: {{ $item->custom_number }}</p>
                                        @endif
                                    </div>
